  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        {/* flex-1 min-h-0 constrains height; centering is on the inner div */}
        <main className="flex-1 min-h-0 overflow-hidden">
          <div className="h-full max-w-6xl mx-auto px-6 py-3 flex flex-col">
            ...
            <div className="text-center mb-3">
              <h1 className="font-[family-name:var(--font-serif)] italic text-snow text-3xl sm:text-4xl leading-tight">
                ...
                return (
                  <div key={step.number} className="flex flex-row items-stretch flex-1 min-w-0">
                    ...
                    <div className="flex-1 liquid-glass rounded-2xl p-4 flex flex-col min-w-0 min-h-0">
                      ...
                      <h2 className="font-[family-name:var(--font-serif)] italic text-snow text-base mb-2">
                        {step.title}
                      </h2>

                      {/* Icon visual */}
                      <div className={`rounded-xl border p-4 mb-2 flex items-center justify-center h-24 ${step.accent}`}>
            ...
            <div className="text-center mt-3">
              ...
              <p className="text-[10px] text-muted mt-1.5">3 free checks daily · No card required</p>
            </div>
